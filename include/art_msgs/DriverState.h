...
struct DriverState_
{
  ...
  DriverState_() : state(0)
  {
  }
  DriverState_(const ContainerAllocator &_alloc) : state(0)
  {
  }
...
template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::DriverState_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::DriverState_<ContainerAllocator> const> : TrueType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::DriverState_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::DriverState_<ContainerAllocator> const> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::DriverState_<ContainerAllocator>> : FalseType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::DriverState_<ContainerAllocator> const> : FalseType
{
};
...
{
template <class ContainerAllocator>
struct Serializer<::art_msgs::DriverState_<ContainerAllocator>>
{
...
struct Printer<::art_msgs::DriverState_<ContainerAllocator>>
{
  ...
  static void stream(Stream &s, const std::string &indent, const ::art_msgs::DriverState_<ContainerAllocator> &v)
  {
    s << indent << "state: ";
