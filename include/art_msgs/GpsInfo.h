...
template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::GpsInfo_<ContainerAllocator>> : FalseType
{
};

template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::GpsInfo_<ContainerAllocator> const> : FalseType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::GpsInfo_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::GpsInfo_<ContainerAllocator> const> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::GpsInfo_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::GpsInfo_<ContainerAllocator> const> : TrueType
{
};
...
{
template <class ContainerAllocator>
struct Serializer<::art_msgs::GpsInfo_<ContainerAllocator>>
{
...
struct Printer<::art_msgs::GpsInfo_<ContainerAllocator>>
{
  ...
  static void stream(Stream &s, const std::string &indent, const ::art_msgs::GpsInfo_<ContainerAllocator> &v)
  {
    s << indent << "header: ";
    s << std::endl;
