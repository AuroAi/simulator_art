...
struct SteeringState_
{
  ...
  SteeringState_() : header(), driver(), angle(0.0), sensor(0.0)
  {
  }
  SteeringState_(const ContainerAllocator &_alloc) : header(_alloc), driver(_alloc), angle(0.0), sensor(0.0)
  {
  }
...
template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::SteeringState_<ContainerAllocator>> : FalseType
{
};

template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::SteeringState_<ContainerAllocator> const> : FalseType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::SteeringState_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::SteeringState_<ContainerAllocator> const> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::SteeringState_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::SteeringState_<ContainerAllocator> const> : TrueType
{
};
...
{
template <class ContainerAllocator>
struct Serializer<::art_msgs::SteeringState_<ContainerAllocator>>
{
...
struct Printer<::art_msgs::SteeringState_<ContainerAllocator>>
{
  ...
  static void stream(Stream &s, const std::string &indent, const ::art_msgs::SteeringState_<ContainerAllocator> &v)
  {
    s << indent << "header: ";
    s << std::endl;
