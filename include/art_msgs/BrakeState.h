...
struct BrakeState_
{
  ...
  BrakeState_() : header(), position(0.0), potentiometer(0.0), encoder(0.0), pressure(0.0)
  {
  }
  BrakeState_(const ContainerAllocator &_alloc)
    : header(_alloc), position(0.0), potentiometer(0.0), encoder(0.0), pressure(0.0)
  {
  }
...
template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::BrakeState_<ContainerAllocator>> : FalseType
{
};

template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::BrakeState_<ContainerAllocator> const> : FalseType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::BrakeState_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::BrakeState_<ContainerAllocator> const> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::BrakeState_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::BrakeState_<ContainerAllocator> const> : TrueType
{
};
...
{
template <class ContainerAllocator>
struct Serializer<::art_msgs::BrakeState_<ContainerAllocator>>
{
...
struct Printer<::art_msgs::BrakeState_<ContainerAllocator>>
{
  ...
  static void stream(Stream &s, const std::string &indent, const ::art_msgs::BrakeState_<ContainerAllocator> &v)
  {
    s << indent << "header: ";
    s << std::endl;
