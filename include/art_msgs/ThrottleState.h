...
struct ThrottleState_
{
  ...
  ThrottleState_() : header(), position(0.0), rpms(0.0), estop(0), pwm(0.0), dstate(0.0), istate(0.0)
  {
  }
  ThrottleState_(const ContainerAllocator &_alloc)
    : header(_alloc), position(0.0), rpms(0.0), estop(0), pwm(0.0), dstate(0.0), istate(0.0)
  {
  }
...
template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::ThrottleState_<ContainerAllocator>> : FalseType
{
};

template <class ContainerAllocator>
struct IsFixedSize<::art_msgs::ThrottleState_<ContainerAllocator> const> : FalseType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::ThrottleState_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct IsMessage<::art_msgs::ThrottleState_<ContainerAllocator> const> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::ThrottleState_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::art_msgs::ThrottleState_<ContainerAllocator> const> : TrueType
{
};
...
{
template <class ContainerAllocator>
struct Serializer<::art_msgs::ThrottleState_<ContainerAllocator>>
{
...
struct Printer<::art_msgs::ThrottleState_<ContainerAllocator>>
{
  ...
  static void stream(Stream &s, const std::string &indent, const ::art_msgs::ThrottleState_<ContainerAllocator> &v)
  {
    s << indent << "header: ";
    s << std::endl;
